 ...
 */
final class Version20231107192334 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event ADD user_id INT NOT NULL, ADD event_type_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event DROP user_id, DROP event_type_id');
    }
}
